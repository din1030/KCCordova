...
if (move_uploaded_file($_FILES['pic_1']['tmp_name'], $target_file)) {
...
if (move_uploaded_file($_FILES['pic_2']['tmp_name'], $target_file)) {
...
if (move_uploaded_file($_FILES['pic_3']['tmp_name'], $target_file)) {
...
if (move_uploaded_file($_FILES['pic_4']['tmp_name'], $target_file)) {
...
if (move_uploaded_file($_FILES['pic_5']['tmp_name'], $target_file)) {
